...
import projectsData from "@/data/projects/rag-systems.json";
...
export const metadata = {
  title: "RAG & Knowledge Systems — ac-ai-agent",
  description: "Portfolio of RAG and knowledge system projects built by ac-ai-agent.",
};
    ...
    <main className="min-h-screen bg-neutral-950 text-white flex flex-col">
      ...
      <section className="border-b border-white/5 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">RAG & Knowledge Systems</h1>
          <p className="text-sm text-neutral-400 mt-2 max-w-xl leading-relaxed">
            Retrieval-augmented generation pipelines that let AI answer questions from your own data, documents, and knowledge bases.
          </p>
        </div>
      </section>
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="md:w-[55%] p-7 flex flex-col justify-center gap-4">
                <div>
                  <p className="text-[10px] font-mono text-neutral-600 uppercase tracking-widest mb-1">RAG & Knowledge Systems</p>
