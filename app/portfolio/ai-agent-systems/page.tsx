...
import projectsData from "@/data/projects/ai-agent-systems.json";
...
export const metadata = {
  title: "AI Agent Systems — ac-ai-agent",
  description: "Portfolio of AI agent systems built by ac-ai-agent.",
};
    ...
    <main className="min-h-screen bg-neutral-950 text-white flex flex-col">
      ...
      <section className="border-b border-white/5 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">AI Agent Systems</h1>
          <p className="text-sm text-neutral-400 mt-2 max-w-xl leading-relaxed">
            Multi-agent systems that reason, plan, and act autonomously — from single-tool agents to orchestrated pipelines.
          </p>
        </div>
      </section>
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="md:w-[55%] p-7 flex flex-col justify-center gap-4">
                <div>
                  <p className="text-[10px] font-mono text-neutral-600 uppercase tracking-widest mb-1">AI Agent Systems</p>
