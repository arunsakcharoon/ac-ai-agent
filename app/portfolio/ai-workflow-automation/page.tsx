...
import projectsData from "@/data/projects/ai-workflow-automation.json";
...
export const metadata = {
  title: "AI Workflow Automation — ac-ai-agent",
  description: "Portfolio of AI workflow automation projects built by ac-ai-agent.",
};
    ...
    <main className="min-h-screen bg-neutral-950 text-white flex flex-col">
      ...
      <section className="border-b border-white/5 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">AI Workflow Automation</h1>
          <p className="text-sm text-neutral-400 mt-2 max-w-xl leading-relaxed">
            End-to-end automation of business processes using LLMs, custom AI agents, and workflow orchestration tools.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-10 flex-1">
        <div className="max-w-5xl mx-auto flex flex-col gap-6">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-gradient-to-br from-violet-900/20 to-neutral-800 p-6">
                    <div className="flex flex-wrap justify-center gap-2">
                      {project.tools.map((tool) => (
                        <span
                          key={tool}
                          className="text-[10px] font-mono bg-white/5 border border-white/10 text-neutral-400 px-2.5 py-0.5 rounded-full"
                        >
                          {tool}
                        </span>
                      ))}
              ...
              <div className="md:w-[55%] p-7 flex flex-col justify-center gap-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {project.tools.map((tool) => (
                    <span
                      key={tool}
                      className="text-[10px] font-mono bg-white/5 border border-white/[0.07] text-neutral-500 px-2 py-0.5 rounded-full"
                    >
                      {tool}
                    </span>
                  ))}
          ...
          <div className="border border-dashed border-white/10 rounded-xl p-10 flex items-center justify-center">
            <p className="text-xs font-mono text-neutral-700">More projects coming soon</p>
          </div>
        </div>
      </section>
